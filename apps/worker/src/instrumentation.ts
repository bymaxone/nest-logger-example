 ...
 * `trace_id`. The OTel SDK packages are the CONSUMER's own dependencies — the
...
/**
 * The worker's OpenTelemetry SDK instance. Exported so the ordered shutdown in
 * `main.ts` can flush pending spans AFTER the log destinations drain.
 */
